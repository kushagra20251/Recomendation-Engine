...
def post_list(request):
    ...
    if request.user.is_authenticated == True and userLiked.objects.filter(username=request.user.username).all().count() >= 8:
        ...
        if data[data.Title == movie_name].values.any() == 0:
            new_data1 = df[df.title == movie_name]
        else:
            new_data1 = data[data.title == movie_name]

        movie_name = movies[1]
        new_data2 = pd.DataFrame()
        if data[data.Title == movie_name].values.any() == 0:
            new_data2 = df[df.title == movie_name]
        else:
            new_data2 = data[data.title == movie_name]
        
        movie_name = movies[2]
        new_data3 = pd.DataFrame()
        if data[data.Title == movie_name].values.any() == 0:
            new_data3 = df[df.title == movie_name]
        else:
            new_data3 = data[data.title == movie_name]

        movie_name = movies[3]
        new_data4 = pd.DataFrame()
        if data[data.Title == movie_name].values.any() == 0:
            new_data4 = df[df.title == movie_name]
        else:
            new_data4 = data[data.title == movie_name]

        movie_name = movies[4]
        new_data5 = pd.DataFrame()
        if data[data.Title == movie_name].values.any() == 0:
            new_data5 = df[df.title == movie_name]
        else:
            new_data5 = data[data.title == movie_name]
        
        movie_name = movies[5]
        new_data6 = pd.DataFrame()
        if data[data.Title == movie_name].values.any() == 0:
            new_data6 = df[df.title == movie_name]
        else:
            new_data6 = data[data.title == movie_name]
        
        movie_name = movies[6]
        new_data7 = pd.DataFrame()
        if data[data.Title == movie_name].values.any() == 0:
            new_data7 = df[df.title == movie_name]
        else:
            new_data7 = data[data.title == movie_name]
        
        movie_name = movies[7]
        new_data8 = pd.DataFrame()
        if data[data.Title == movie_name].values.any() == 0:
            new_data8 = df[df.title == movie_name]
        else:
...
def getmoviename(request):
    df = pd.read_csv("blog/movie_dataset.csv")
    title=df.title.tolist()
    return JsonResponse(data={'flag':title  })
